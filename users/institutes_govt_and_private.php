  ...
  <div class="leftContent">
    ...
    <div class="row justify-content-center" >
      ...
      <form method="POST" action="database/admin_data.php">
       <h3 align="center" class="mb-4 mt-4">Instrumentation Facility Form for Institutes (Govt. and Private)</h3>
       <br>
      ...
      <div class="row mb-2 justify-content-center">
          <div class="col-md-8">
            <div class="input-group mb-4">
              ...
              <input type="text" class="form-control" placeholder="Name of Institute" name="institute">
            </div>
          </div>
      </div>
